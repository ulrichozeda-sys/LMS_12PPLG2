  ...
  return (
    <div className="flex min-h-screen flex-col bg-[#FFFFFF]" style={{ fontFamily: "Inter, sans-serif" }}>
      ...
      <div className="mx-auto flex w-full max-w-7xl flex-1 px-4 py-6 sm:px-6">
        ...
        <aside aria-label="Navigasi kepsek" className={`fixed inset-y-0 left-0 z-50 w-72 overflow-y-auto bg-[#FFFFFF] p-4 shadow-[8px_0_24px_rgba(15,23,42,0.12)] transition-transform duration-300 ease-out ${sidebarOpen ? "translate-x-0" : "-translate-x-full"}`}>
